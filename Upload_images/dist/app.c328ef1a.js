...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"bytes_converter.js":[function(require,module,exports) {
"use strict";
...
var _bytes_converter = require("./bytes_converter");
...
function upload() {
  ...
  var open = createElement('button', ['btn'], 'Открыть');
  var preview = createElement('div', ['preview']);
  var upload = createElement('button', ['btn', 'btn-upload'], 'Загрузить');
  ...
  var changeHandler = function changeHandler(event) {
    ...
    files.forEach(function (file) {
      ...
      reader.onload = function (event) {
        preview.insertAdjacentHTML('beforeend', "\n            <div class=\"preview-image\">\n               <div class=\"preview-remove\" data-name=\"".concat(file.name, "\">&times;</div>\n               <img src=\"").concat(event.target.result, "\" alt=\"").concat(file.name, "\" />\n               <div class=\"preview-info\">\n                  <span>").concat(file.name, "</span>\n                  <span>").concat((0, _bytes_converter.bytesToSize)(file.size), "</span>\n               </div>\n            </div>\n            "));
      };
...
},{"./bytes_converter":"bytes_converter.js"}],"node_modules/tslib/tslib.es6.js":[function(require,module,exports) {
"use strict";
...
},{"@firebase/storage":"node_modules/@firebase/storage/dist/index.esm.js"}],"app.js":[function(require,module,exports) {
"use strict";
...
},{"./upload.js":"upload.js","firebase/app":"node_modules/firebase/app/dist/index.esm.js","firebase/storage":"node_modules/firebase/storage/dist/index.esm.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
